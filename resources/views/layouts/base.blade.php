        ...
        {{-- <div class="wrapper"> --}}
            ...
            <nav class="navbar desktop-navbar navbar-expand-lg bg-theme navbar-dark p-1" >
                <div class="container">
                    ...
                    <a href="{{ route('homepage') }}" class="navbar-brand logo"><img src="{{ asset('logo/'.site()->logo) }}" style="height:45px;" alt="" class="img-fluid"></a>
        ...
        <div class="container-fluid p-0" style="background-color: #1c313a77;">
            <div class="container py-5">
                <div class="row row-cols-lg-2 row-cols-md-2 rows-cols-sm-2 row-cols-1">
                    <div class="col mb-4">
                        <div class="ad-pro">
                            <div class="img"><img src="{{ asset('logo/'.site()->logo) }}" class="img-fluid" alt=""></div>
    ...
    <nav class="navbar navbar-expand-lg d-lg-none mobile-foot-menu navbar-light bg-white fixed-bottom">
        <div class="container ">
            <div class="row d-flex w-100">
                ...
                <div class="col-3 text-center text-dark">
                    <a href="@auth{{ route('my.orders') }}@endauth  @guest{{ route('user.login') }}@endguest" class=" text-decoration-none text-dark">
